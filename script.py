...
# Usando o modelo 1.5-flash que é mais estável no plano gratuito
...
prompt = f"""
Atue como editor do site "Fiscal de Minuto". Use os links abaixo para gerar o conteúdo.
Siga a estrutura HTML das classes .section-header, .news-card, .card-title, .card-body.
Mantenha o visual: caixas, cores e emojis.
Apenas devolva o código HTML, sem introduções.
Links: {links}
"""
